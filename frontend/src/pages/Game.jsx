        ...
        >
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              ...
              <button 
                onClick={() => {
                  const myGuesses = players.find(p => p.id === playerId)?.guesses || [];
                  const shareText = `🌍 GlobleGuess\n${isWinner ? 'Found the country in ' + myGuesses.length + ' guesses!' : 'Played a great game!'}\n\nPlay here: https://globleguess.vercel.app`;
